...
:creationdate: 04/05/17 16:57
:moduleauthor: François GUÉRIN <fguerin@ville-tourcoing.fr>
:modulename: wagtailleaflet.widget
...
__author__ = 'fguerin'
logger = logging.getLogger('wagtailleaflet.widgets')


# noinspection PyClassHasNoInit
class LeafletWidget(leaflet_widgets.LeafletWidget):
